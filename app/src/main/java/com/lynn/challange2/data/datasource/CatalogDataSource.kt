...
class CatalogDataSourceImpl() : CatalogDataSource {
    override fun getCatalogData(): List<Catalog> {
        return mutableListOf(
            ...
            Catalog(
                image = R.drawable.img_maratabakmanis,
                price = 20000.00,
                name = "Martabak Manis",
            ...
            Catalog(
                image = R.drawable.img_pisangmolen,
                price = 5000.00,
                name = "Pisang Molen",
            ...
            Catalog(
                image = R.drawable.img_tahupetis,
                price = 10000.00,
                name = "Tahu Petis",
